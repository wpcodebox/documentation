...
To log any errors or notices, you can use [WP Debug Toolkit](https://wpdebugtoolkit.com/), the best tool to easily handle error logs and troubleshooting. We partnered with them to offer a discount, just use code __WPCBDOC__ when you checkout.
